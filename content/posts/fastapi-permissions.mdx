...
<Image src="/thumbnails/fastapi-logo.png" alt="FastAPI permissions 구현하기" />
...
`PermissionChecker` 객체에서 permission을 검사하는 로직을 구현합니다. 그게 `check_permissions` 와 `check_object_permissions` 입니다.
