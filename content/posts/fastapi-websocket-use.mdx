...
description: 예전에 했던 사이드 프로젝트 중에서 WebSocket을 사용했던 있습니다. FastAPI를 이용해서 websocket을 구현했었는데요. 아주 쉽게 구현이 가능해서 금새 만들었습니다. 그 방법을 이번 포스팅에서 공유해보려고 합니다.
tags: [FastAPI]
author: mingke
...
예전에 했던 사이드 프로젝트 중에서 **WebSocket**을 사용했던 있습니다. FastAPI를 이용해서 websocket을 구현했었는데요. 아주 쉽게 구현이 가능해서 금새 만들었습니다. 그 방법을 이번 포스팅에서 공유해보려고 합니다.
